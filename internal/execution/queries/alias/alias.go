...
import (
	...
	projectionNode "github.com/efritz/gostgres/internal/execution/queries/projection"
)
...
func NewAlias(node queries.Node, name string) queries.Node {
	...
	return projectionNode.NewProjection(node, p)
}
...
// 	return fmt.Sprintf("alias %q", n.name)
// }
