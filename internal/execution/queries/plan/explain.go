...
func NewExplain(n LogicalNode) LogicalNode {
...
func (n *logicalExplain) Name() string                                                        { return "EXPLAIN" }
func (n *logicalExplain) Fields() []fields.Field                                              { return []fields.Field{queryPlanField} }
