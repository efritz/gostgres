...
var builtinFactories = map[string]func() relations.Relation{
	"employees":   newEmployeesRelation,
	"departments": newDepartmentsRelation,
	"locations":   newLocationsRelation,
	"regions":     newRegionsRelation,
}

func newEmployeesRelation() relations.Relation {
...
func newDepartmentsRelation() relations.Relation {
	return relations.NewData(
		"departments",
		shared.Rows{
			Fields: []shared.Field{
...
func newLocationsRelation() relations.Relation {
	return relations.NewData(
		"locations",
		shared.Rows{
			Fields: []shared.Field{
...
func newRegionsRelation() relations.Relation {
	return relations.NewData(
		"regions",
		shared.Rows{
			Fields: []shared.Field{
